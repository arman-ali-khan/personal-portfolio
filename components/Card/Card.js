...
const Card = () => {
    return (
      ...
      <div className="w-full px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        <div className="flex justify-center -mt-16 md:justify-end relative">
         
          <a className="relative" href="https://ledp.ictd.gov.bd/">
            <img
              className="object-cover w-20 h-20 border-2 border-blue-500 rounded-full dark:border-blue-400 bg-blue-300 "
