...
const Blogs = () => {
  return (
    <div>
      ...
      <div class="x-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div className="flex md:block lg:flex gap-3">
          ...
          <div class="mt-2 w-full">
            <a
              href="#"
              class="text-lg leading-6 font-bold text-gray-700 dark:text-white hover:text-gray-600 dark:hover:text-gray-200 hover:underline"
              tabindex="0"
              role="link"
            >
              Accessibility tools for designers and developers
            </a>
            <p class="mt-2 text-gray-600 text-xs sm:text-base dark:text-gray-300">
