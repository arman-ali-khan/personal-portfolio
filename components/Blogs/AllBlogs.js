...
const AllBlogs = () => {
    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
           ...
           <div className="flex">
    <a href="#" className="flex items-center border px-4 py-2 mx-1 text-gray-500 bg-white rounded-md cursor-not-allowed dark:bg-gray-800 dark:text-gray-600">
        previous
    </a>

    <a href="#" className="items-center border hidden px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-white rounded-md sm:flex dark:bg-gray-800 dark:text-gray-200 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white dark:hover:text-gray-200">
        1
    </a>
    ...
    <a href="#" className="flex items-center border px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-white rounded-md dark:bg-gray-800 dark:text-gray-200 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white dark:hover:text-gray-200">
        Next
    </a>
</div>
           </div>
