    ...
    return (
        <div>
           ...
           <div className='w-full'>
            <div className='w-3/12 border h-screen'>
                <ul>
                    <li className=''><Link className='px-4 py-2 w-full bg-blue-100 hover:bg- border-b inline-block' href={''}>Dashboard</Link></li>
                    <li className=''><Link className='px-4 py-2 w-full bg--100 border-b inline-block' href={''}>Dashboard</Link></li>
                    <li className=''><Link className='px-4 py-2 w-full bg-blue-100 hover:bg- border-b inline-block' href={''}>Dashboard</Link></li>
                </ul>
            </div>
    ...
    <div className="flex flex-col justify-between flex-1 mt-6">
        <nav className="-mx-3 space-y-6 ">
            <div className="space-y-3 ">
                ...
                <Link className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href={'/dashboard'}>
                ...
                <Link className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href={'/dashboard/users'}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
